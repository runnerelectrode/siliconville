...
export function findRoute(
  ...
  destination: Point,
  /**
   * Tiles per second. Defaults to the global walking pace.
   *
   * Per-route rather than global because a person exploring and an agent
   * living its life want different speeds: 0.75 t/s is a fine amble for an
   * NPC and glacial for someone trying to cross a 256-tile map, which takes
   * over five minutes at that rate.
   */
  speed: number = movementSpeed,
) {
