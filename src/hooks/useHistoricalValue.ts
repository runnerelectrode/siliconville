...
// Exported so a non-React render loop can use it. The hook above is fine
// for one value in one component; a scene drawing dozens of moving figures
// cannot call a hook per figure, and re-rendering React every frame to get
// a position is the thing we are trying to avoid.
